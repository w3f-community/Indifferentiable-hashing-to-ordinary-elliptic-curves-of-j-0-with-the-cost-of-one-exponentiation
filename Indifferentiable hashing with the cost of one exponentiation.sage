...
class TestIndiffJInvJ0Hash(unittest.TestCase):
        ...
        # 
        def hash_random_point_to_curve(self, ec_with_0_j_inv):
        ...
        def compute_and_verify_several_hashes(self, Fq, b):
                Eb = self.generate_elliptic_curve(Fq, b)
                print(f"testing hashing to {Eb}")
                for i in range(0,self.NUMBER_TEST_HASHES):
                        hash_random_point_to_curve(Eb)

        def generate_elliptic_curve(self, Fq, b):
                return EllipticCurve(self.Fq, [0,self.b])

        def generate_bls12_params(self, u, b):
        ...
        def test_bls12_377(self):
                ...
                Fq, b = self.generate_bls12_params(u, b)
                self.compute_and_verify_several_hashes(Fq,b,self.NUMBER_TEST_HASHES)
