...
def hPrime(r, w,w2, b, m, z,z2, num0,num1,num2,den, t1,t2):
	v = den^2
	u = num0^2 - b*v
	th = crtRatio(r, m, u,v)   # theta from [1, Section 3]
	v = th^3*v
	L = [t1, w*t1, w2*t1]
	L.sort()
	n = L.index(t1)
...
# Map h: (Fq)^2 -> Eb(Fq)
def h(r, w,w2, b,sb, m, z,z2, c, X0,Y0,Z0, t1,t2):
	num0,num1,num2,den = phi(b,sb, c, t1,t2)
	X,Y,Z = hPrime(r, w,w2, b, m, z,z2, num0,num1,num2,den, t1,t2)
	if t1*t2 == 0:
		X = X0; Y = Y0; Z = Z0   
...
def H(r, Fq, w,w2, b,sb, m, z,z2, c, s, X0,Y0,Z0):
	t1,t2 = eta(Fq, s)
	return h(r, w,w2, b,sb, m, z,z2, c, X0,Y0,Z0, t1,t2) 
